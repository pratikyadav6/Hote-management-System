                        ...
                        <div class="p-3 p-md-4 p-xl-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="d-flex p-2 bd-highlight">
                                    ...
                                    <div class="col-12">
                                        <div>
                                            <button class="btn bsb-btn-xl btn-primary" name="submit" type="submit">Add catagory</button>
                                        </div>
                                    </div>
                                        ...
                                        ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a onclick="return confirm('Are you sure?')" href="add_catagory.php?id=<?php echo $row['category'] ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                            } ?>
...
if (isset($_POST['submit'])) {
    ...
    if ($count == 0) {
        ...
        $result = mysqli_query($conn, $sql);
        echo "<script>window.location.href='add_catagory.php'</script>";
