            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="" method="get">
                        ...
                        <input type="date" class="form-input" name="date" value="<?php echo isset($_GET['date']) ? htmlspecialchars($_GET['date']) : ''; ?>">
                        <button type="submit" name="submit">Submit</button>
                    </form>

                    <button type="button" id="printButton" style="display: none;" onclick="printReport()">Print</button>

                    <div style="padding:50px;" class="card-container" id="report-container">
                        <?php
                        if (isset($_GET['submit']) && !empty($_GET['date'])) {
                            include 'sales_report_print.php';
                        } else {
