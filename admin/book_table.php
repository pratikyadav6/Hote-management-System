    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="" method="post"> <input type="number" id="table_no" name="table_no" placeholder="Enter Table No "></form>
                <script>
                    ...
                    if (isset($_POST['table_no'])) {
                        $id = $_POST['table_no'];
                        $sql = "SELECT  table_no from tables WHERE table_no=$id";
                    ...
                    <div class="card-container">
                        ...
                        ?>
                                ...
                                <a href="../admin/orders.php?id_table=<?php echo $row['table_no'] ?>" class="card">
